...
export class PersonalInfoViewComponent implements OnInit {
  ...
  activeTab(): void {
    ...
    switch (fragment) {
      case this.personal: this.tabIndex = 0; break
      case this.patienten: this.tabIndex = 1; break
      case this.diagnose: this.tabIndex = 2; break
      case this.krankheiten: this.tabIndex = 3; break
      case this.allergien: this.tabIndex = 4; break
      case this.medikamenten: this.tabIndex = 5; break
    }
  }
  ...
  onTabClicked(event: MatTabChangeEvent): void {
    ...
    switch (event.index) {
      case 0:  this.navTo(this.personal); break
      case 1:  this.navTo(this.patienten); break
      case 2:  this.navTo(this.diagnose); break
      case 3:  this.navTo(this.krankheiten); break
      case 4:  this.navTo(this.allergien); break
      case 5:  this.navTo(this.medikamenten); break
    }
  }
